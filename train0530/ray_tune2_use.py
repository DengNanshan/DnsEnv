...
config={
    "lr": 1e-2,#tune.grid_search([ 1e-2, 1e-3,1e-4]),
    "gamma" :7e-1#tune.grid_search([5e-1, 7e-1, 9e-1, 95e-2, 97e-2])
}
config_env = {
    "observation": {
        "type": "Kinematics",
...
model=DQN.load(('/home/be-happy/ray_results/Data0530_tune/DQN_2021_05_30_01_44_32.zip'),env)
