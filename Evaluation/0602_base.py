...
model1 = DQN.load(model_name["name23"] , env)
model2 = DQN.load(model_name["name24"] , env)
model3 = DQN.load(model_name["name25"] , env)
model4 = DQN.load(model_name["name26"] , env)
model5 = DQN.load(model_name["name27"] , env)
model6 = DQN.load(model_name["name28"] , env)
model7 = DQN.load(model_name["name29"] , env)
model8 = DQN.load(model_name["name2"] , env)
model9 = DQN.load(model_name["name3"] , env)
...
#     obs[1, 3] = i/10
#     """plot max"""
#     print(i, np.argmax(model1.action_probability(obs).round(2)))
#     print(i, np.argmax(model2.action_probability(obs).round(2)))
#     print(i, np.argmax(model3.action_probability(obs).round(2)))
#     print(i, np.argmax(model4.action_probability(obs).round(2)))
#     print(i, np.argmax(model5.action_probability(obs).round(2)))
#     print(i, np.argmax(model6.action_probability(obs).round(2)))
#     print(i, np.argmax(model7.action_probability(obs).round(2)))
#     print(i, np.argmax(model8.action_probability(obs).round(2)))
#     print(i, np.argmax(model9.action_probability(obs).round(2)))

    # """print prob"""
#     # print(i, model1.action_probability(obs).round(2))
...
#     # print(i, model.action_probability(obs).round(2), env.action_type.ACTIONS_ALL[action])
#     # action, _state = model2.predict(obs)
#     # print(i, model2.action_probability(obs).round(2), env.action_type.ACTIONS_ALL[action])
#     # action, _state = model3.predict(obs)
#     # print(i, model3.action_probability(obs).round(2), env.action_type.ACTIONS_ALL[action])
