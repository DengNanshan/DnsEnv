...
model.tensorboard_log="../../Data/tensorboard_log_fello/"
model.gamma=0.7
...
timetemp=datetime.datetime.now().strftime("DQN3_goon_%Y_%m_%d_%H_%M_%S")
checkpoint_callback=CheckpointCallback(save_freq=10000,

                                       save_path='../../Data/'+timetemp,
                                       name_prefix='deeq_highway_check',
                                       verbose=1)

E=EvalCallback(eval_env=env,eval_freq=10000,log_path='../../Data/'+timetemp,best_model_save_path='../../Data/'+timetemp)

callbacks=CallbackList([checkpoint_callback,E])
model.learn(10000000,callback=callbacks)

model.save('../../Data/DQN3_go_on')
...
model=DQN.load(('../../Data/DQN3_go_on'),env)
obs=env.reset()
i=0
ve=[]
begin = time.time()
