...
for i in range(1000):
    ...
    # print(env.vehicle.road.neighbour_vehicles(vehicle=env.))
    print(obs.round(2))
    # if dones:
    #     env.reset()
    # env.vehicle.road.neighbour_vehicles(vehicle=env.vehicle, lane_index=('0', '1', 3))[0]
    # env.vehicle.road.neighbour_vehicles(vehicle=env.vehicle, lane_index=('0', '1', 0))
