...
#            tensorboard_log="../../Data4/tensorboard_log_fello/",
...
#            buffer_size=100000)
#
# timetemp=datetime.datetime.now().strftime("DQN3_%Y_%m_%d_%H_%M_%S")
...
#                                        verbose=1)
#
# E=EvalCallback(eval_env=env,eval_freq=1000,log_path='../../Data4/'+timetemp,best_model_save_path='../../Data4/'+timetemp)
#
# callbacks=CallbackList([checkpoint_callback,E])
# model.learn(10000,callback=callbacks)
#
# model.save('../../Data4/DQN3_model')
#
# del model
...
model=DQN.load(('../../Data4/DQN3_model'),env)
obs=env.reset()
i=0
ve=[]
begin = time.time()
