...
timetemp=datetime.datetime.now().strftime("DQN1_%Y_%m_%d_%H_%M_%S")
checkpoint_callback=CheckpointCallback(save_freq=1000,
                                       save_path='../../Data3/'+timetemp,
                                       name_prefix='deeq_highway_check',
                                       verbose=1)

E=EvalCallback(eval_env=env,eval_freq=1000,log_path='../../Data3/'+timetemp,best_model_save_path='../../Data3/'+timetemp)

callbacks=CallbackList([checkpoint_callback,E])
model.learn(20000,callback=callbacks)

model.save('../../Data3/DQN1')
