...
from stable_baselines3.sac.policies import SACPolicy,MlpPolicy
...
timetemp=datetime.datetime.now().strftime("SAC_12_%Y_%m_%d_%H_%M_%S")
...
model=SAC.load('../../Data3/SAC_12',env)
