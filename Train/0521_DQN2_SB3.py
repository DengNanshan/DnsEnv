...
#            gamma=0.9)
#
# timetemp=datetime.datetime.now().strftime("DQN2%Y_%m_%d_%H_%M_%S")
...
# model.learn(30000,callback=callbacks)
#
# model.save('../../Data2/DQN2')
#
# del model
...
model=DQN.load(('../../Data2/DQN22021_05_20_23_51_41/best_model'),env)
obs=env.reset()
i=0
ve=[]
begin = time.time()
