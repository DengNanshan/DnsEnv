...
config = {
    ...
    "reward_speed_range": [25, 30],  # [m/s] The reward for high speed is mapped linearly from this range to [0, HighwayEnv.HIGH_SPEED_REWARD].
...
timetemp=datetime.datetime.now().strftime("DQN12%Y_%m_%d_%H_%M_%S")
...
#
# model=DQN.load(('../../Data2/DQN92021_05_21_02_22_18/best_model'),env)
# obs=env.reset()
# i=0
# ve=[]
# begin = time.time()
