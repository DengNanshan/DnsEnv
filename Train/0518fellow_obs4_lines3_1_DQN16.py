...
#
#
# timetemp=datetime.datetime.now().strftime("DQN16%Y%m_%d_%H_%M_%S")
...
# model.learn(200000,callback=callbacks,eval_freq=10000)
# model.save('../../Data/DQN14_V5_L4_DQN16_count10')
#
# del model
...
model=DQN.load(('../../Data/DQN21202105_18_18_24_20/best_model'),env)
